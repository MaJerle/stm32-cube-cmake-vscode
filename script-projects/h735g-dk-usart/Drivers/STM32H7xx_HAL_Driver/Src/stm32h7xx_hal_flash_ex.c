...
/**
  ...
  */
static void
FLASH_OB_PCROPConfig(uint32_t PCROPConfig, uint32_t PCROPStartAddr, uint32_t PCROPEndAddr, uint32_t Banks) {
    /* Check the parameters */
    assert_param(IS_FLASH_BANK(Banks));
...
/**
  ...
  */
static void
FLASH_OB_GetPCROP(uint32_t* PCROPConfig, uint32_t* PCROPStartAddr, uint32_t* PCROPEndAddr, uint32_t Bank) {
    uint32_t regvalue = 0;
    uint32_t bankBase = 0;
...
/**
  ...
  */
static void
FLASH_OB_BootAddConfig(uint32_t BootOption, uint32_t BootAddress0, uint32_t BootAddress1) {
    /* Check the parameters */
...
/**
  ...
  */
static void
FLASH_OB_CM4BootAddConfig(uint32_t BootOption, uint32_t BootAddress0, uint32_t BootAddress1) {
    /* Check the parameters */
    assert_param(IS_OB_BOOT_ADD_OPTION(BootOption));
...
/**
  ...
  */
static void
FLASH_OB_GetCM4BootAdd(uint32_t* BootAddress0, uint32_t* BootAddress1) {
    uint32_t regvalue;
...
/**
  ...
  */
static void
FLASH_OB_SecureAreaConfig(uint32_t SecureAreaConfig, uint32_t SecureAreaStartAddr, uint32_t SecureAreaEndAddr, uint32_t Banks) {
    /* Check the parameters */
    assert_param(IS_FLASH_BANK(Banks));
...
/**
  ...
  */
static void
FLASH_OB_GetSecureArea(uint32_t* SecureAreaConfig, uint32_t* SecureAreaStartAddr, uint32_t* SecureAreaEndAddr, uint32_t Bank) {
    uint32_t regvalue = 0;
    uint32_t bankBase = 0;
...
/**
  ...
  */
static void
FLASH_CRC_SelectAddress(uint32_t CRCStartAddr, uint32_t CRCEndAddr, uint32_t Bank) {
    if (Bank == FLASH_BANK_1) {
...
/**
  ...
  */
static void
FLASH_OB_OTP_LockConfig(uint32_t OTP_Block) {
    /* Check the parameters */
