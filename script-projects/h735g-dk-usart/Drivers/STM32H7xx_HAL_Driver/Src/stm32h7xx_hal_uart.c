...
/**
  ...
  */
HAL_StatusTypeDef
HAL_UART_RegisterCallback(UART_HandleTypeDef* huart, HAL_UART_CallbackIDTypeDef CallbackID,
...
/**
  ...
  */
void
HAL_UART_ReceiverTimeout_Config(UART_HandleTypeDef* huart, uint32_t TimeoutValue) {
    if (!(IS_LPUART_INSTANCE(huart->Instance))) {
...
/**
  ...
  */
HAL_StatusTypeDef
UART_WaitOnFlagUntilTimeout(UART_HandleTypeDef* huart, uint32_t Flag, FlagStatus Status,
