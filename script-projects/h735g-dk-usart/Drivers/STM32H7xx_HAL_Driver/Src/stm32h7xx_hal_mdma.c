...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_Init(MDMA_HandleTypeDef* hmdma) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_DeInit(MDMA_HandleTypeDef* hmdma) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_ConfigPostRequestMask(MDMA_HandleTypeDef* hmdma, uint32_t MaskAddress, uint32_t MaskData) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_RegisterCallback(MDMA_HandleTypeDef* hmdma, HAL_MDMA_CallbackIDTypeDef CallbackID, void (* pCallback)(MDMA_HandleTypeDef* _hmdma)) {
    HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_UnRegisterCallback(MDMA_HandleTypeDef* hmdma, HAL_MDMA_CallbackIDTypeDef CallbackID) {
    HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_LinkedList_CreateNode(MDMA_LinkNodeTypeDef* pNode, MDMA_LinkNodeConfTypeDef* pNodeConfig) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_LinkedList_AddNode(MDMA_HandleTypeDef* hmdma, MDMA_LinkNodeTypeDef* pNewNode, MDMA_LinkNodeTypeDef* pPrevNode) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_LinkedList_RemoveNode(MDMA_HandleTypeDef* hmdma, MDMA_LinkNodeTypeDef* pNode) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_LinkedList_EnableCircularMode(MDMA_HandleTypeDef* hmdma) {
    HAL_StatusTypeDef hal_status = HAL_OK;
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_LinkedList_DisableCircularMode(MDMA_HandleTypeDef* hmdma) {
    HAL_StatusTypeDef hal_status = HAL_OK;
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_Abort(MDMA_HandleTypeDef* hmdma) {
    uint32_t tickstart =  HAL_GetTick();
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_Abort_IT(MDMA_HandleTypeDef* hmdma) {
    /* Check the MDMA peripheral handle */
    if (hmdma == NULL) {
        return HAL_ERROR;
    }
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_PollForTransfer(MDMA_HandleTypeDef* hmdma, HAL_MDMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout) {
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_MDMA_GenerateSWRequest(MDMA_HandleTypeDef* hmdma) {
...
/**
  ...
  */
void
HAL_MDMA_IRQHandler(MDMA_HandleTypeDef* hmdma) {
...
HAL_MDMA_GetState(MDMA_HandleTypeDef* hmdma) {
    return hmdma->State;
}
...
/**
  ...
  */
uint32_t
HAL_MDMA_GetError(MDMA_HandleTypeDef* hmdma) {
...
/**
  ...
  */
static void
MDMA_SetConfig(MDMA_HandleTypeDef* hmdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t BlockDataLength, uint32_t BlockCount) {
    uint32_t addressMask;
