...
static void
TimerCallback (TimerHandle_t hTimer) {
...
osMemoryPoolId_t
osMemoryPoolNew (uint32_t block_count, uint32_t block_size, const osMemoryPoolAttr_t* attr) {
    MemPool_t* mp;
    const char* name;
...
*/
static void
FreeBlock (MemPool_t* mp, void* block) {
